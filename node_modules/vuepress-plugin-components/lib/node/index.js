...
`)},Ne=(e,t=!0)=>a=>(t&&Ve(e),a.env.isDebug&&r.info("Options:",e),Q(a,{id:"hope"}),{name:z,define:Me(e,t),extendsBundlerOptions:(o,s)=>{e?.components?.includes("ArtPlayer")&&U(o,s,"artplayer"),e?.components?.includes("VidStack")&&q(o,s,/^media-/),G(o,s,["@vuepress/helper","vuepress-shared"])},clientConfigFile:o=>Re(o,e,t)});export{O as AVAILABLE_SERVICES,u as SHARE_CONFIG,L as backToTopLocales,Ne as componentsPlugin,V as pdfLocaleConfig,M as siteInfoLocaleConfig,R as vidstackLocales};
